...
new_customer()
{
	...
	//ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("D:\\backgroundimage.png"));
...
public void actionPerformed(ActionEvent ev) {
	...
	if(ev.getSource()==b1) {
		...
		try {
			...
			String q="insert into customer_info values('"+name+"','"+meterno+"','"+address+"','"+state+"','"+city+"','"+email_id+"','"+phoneno+"')";
